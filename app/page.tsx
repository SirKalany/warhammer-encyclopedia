  ...
  return (
    <div className="space-y-16">
      ...
      <div className="text-center space-y-5 py-16">
        <p className="font-display text-xs tracking-[0.35em] uppercase text-gold-mid">
          Total War: Warhammer III
        </p>

        <h1 className="text-6xl font-display font-bold text-gold-bright">
          WHEncyclopedia
        </h1>

        <p className="text-text-secondary font-body text-lg max-w-2xl mx-auto italic">
          A complete reference for units, factions, buildings, spells and more.
        </p>

        <div className="w-32 h-px bg-gold-dim mx-auto mt-6" />
      </div>
          ...
          {SECTIONS.map((section) => (
            <Link
              ...
              className="
                ...
                rounded-lg p-7 no-underline overflow-hidden
            ...
            >
              ...
              <div className="text-4xl mb-4 text-gold-dim group-hover:text-gold-bright transition-colors duration-150">
                {section.icon}
              </div>
